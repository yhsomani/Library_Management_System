...
public class IssuedBookDetails extends javax.swing.JFrame {
    ...
    private void setIssuedBookDetailsPendingStatusToTable() {
        // Updated SQL query to filter only pending status
        String sqlQuery = "SELECT * FROM issue_book_details WHERE status = 'Pending'";

        try (Connection con = DBConnection.getConnection(); Statement st = con.createStatement(); ResultSet rs = st.executeQuery(sqlQuery)) {

            model = (DefaultTableModel) tbl_issuedBookDetailsPendingStatus.getModel();
            model.setRowCount(0);
    ...
    private void initComponents() {
        ...
        tbl_issuedBookDetailsPendingStatus = new rojeru_san.complementos.RSTableMetro();
        ...
        tbl_issuedBookDetailsPendingStatus.setAutoCreateRowSorter(true);
        tbl_issuedBookDetailsPendingStatus.setBackground(new java.awt.Color(255, 255, 255));
        tbl_issuedBookDetailsPendingStatus.setForeground(new java.awt.Color(0, 0, 0));
        tbl_issuedBookDetailsPendingStatus.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tbl_issuedBookDetailsPendingStatus.setColorBackgoundHead(new java.awt.Color(102, 102, 255));
        tbl_issuedBookDetailsPendingStatus.setColorBordeFilas(new java.awt.Color(102, 102, 255));
        tbl_issuedBookDetailsPendingStatus.setColorFilasBackgound2(new java.awt.Color(255, 255, 255));
        tbl_issuedBookDetailsPendingStatus.setColorSelBackgound(new java.awt.Color(255, 51, 51));
        tbl_issuedBookDetailsPendingStatus.setFont(new java.awt.Font("Yu Gothic UI Light", 0, 25)); // NOI18N
        tbl_issuedBookDetailsPendingStatus.setFuenteFilas(new java.awt.Font("Yu Gothic UI Semibold", 0, 18)); // NOI18N
        tbl_issuedBookDetailsPendingStatus.setFuenteFilasSelect(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        tbl_issuedBookDetailsPendingStatus.setFuenteHead(new java.awt.Font("Yu Gothic UI Semibold", 1, 20)); // NOI18N
        tbl_issuedBookDetailsPendingStatus.setGridColor(new java.awt.Color(255, 255, 255));
        tbl_issuedBookDetailsPendingStatus.setRowHeight(30);
        tbl_issuedBookDetailsPendingStatus.setSelectionForeground(new java.awt.Color(255, 255, 255));
        tbl_issuedBookDetailsPendingStatus.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(tbl_issuedBookDetailsPendingStatus);
    ...
    private rojeru_san.complementos.RSTableMetro tbl_issuedBookDetailsPendingStatus;
